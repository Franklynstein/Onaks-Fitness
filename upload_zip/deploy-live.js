...
async function deploy() {
  console.log("Ì∫Ä ONAKS FITNESS - Live Deployment");
  console.log("===============================================");
  ...
  console.log("===============================================");
  console.log(`Ìæâ DEPLOYMENT COMPLETE: ${added} added, ${exists} existed`);
  console.log("Ì≤° Your database is ready for production!");
}
